<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">DISCOVER</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/666ghj/DISCOVER" target="_blank" class="github-link">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="../assets/logo/DISCOVER_logo_left.jpeg" alt="DISCOVER Logo" class="hero-logo" />
          </div>
